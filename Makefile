...
# middlewaregruppen/banana-controller-bundle:$VERSION and middlewaregruppen/banana-controller-catalog:$VERSION.
IMAGE_TAG_BASE ?= middlewaregruppen/banana-controller
